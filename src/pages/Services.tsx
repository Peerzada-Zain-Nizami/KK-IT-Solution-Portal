  ...
  const services = [
    {
      ...
      description:
        "Create modern, responsive websites using the latest technologies like React, Vue, and Node.js.",
      features: [
        "Responsive Design",
        "SEO Optimized",
        "Fast Loading",
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description:
        "Design beautiful and intuitive user interfaces that enhance user experience and engagement.",
      features: [
        "User Research",
        "Wireframing",
        "Prototyping",
    ...
    },
    {
      ...
      title: "DevOps & Cloud",
      description:
        "Implement scalable infrastructure and deployment solutions for your applications.",
      features: [
        "Cloud Migration",
        "CI/CD Pipelines",
        "Monitoring",
    ...
    },
    {
      ...
      description:
        "Build powerful online stores with payment integration and inventory management.",
      features: [
        "Payment Gateway",
